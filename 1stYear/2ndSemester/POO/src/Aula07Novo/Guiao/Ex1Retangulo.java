...
public class Ex1Retangulo extends Ex1Forma {
    private double valor1;
    private double valor2;

    Ex1Retangulo(String cor, double valor1, double valor2) {
        super(cor);
    ...
    public boolean equals(Ex1Retangulo b) {
        return this.valor1 == b.getComprimento() && this.valor2 == b.getAltura();
    }

    public boolean equalsCor(Ex1Retangulo b) {
