...
public class Voo {
    ...
    public int getAtrasoSegundos() {
        return Integer.parseInt(this.getAtraso().substring(0, 2)) * 3600
                + Integer.parseInt(this.getAtraso().substring(3, 5)) * 60;
    }
    ...
    private String getPrevisao() {
        int hora_previsao_int = Integer.parseInt(this.hora.substring(0, 2))
                + Integer.parseInt(this.atraso.substring(0, 2));
        int minuto_previsao_int = Integer.parseInt(this.hora.substring(3, 5))
                + Integer.parseInt(this.atraso.substring(3, 5));
    ...
    public String toString() {
        return String.format("%-7s %-8s %-20s %-21s %-7s %-20s", this.hora, this.id, this.companhia, this.origem,
                this.atraso, this.obs);
    }
