...
-- pin_name1	=>  Location: PIN_K4,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \inst|and_1~0_combout\ = (\SW[4]~input_o\ & (\SW[0]~input_o\ & (\SW[1]~input_o\ $ (!\SW[5]~input_o\)))) # (!\SW[4]~input_o\ & (!\SW[0]~input_o\ & (\SW[1]~input_o\ $ (!\SW[5]~input_o\))))
...
-- Equation(s):
-- \inst|and_1~1_combout\ = (\SW[3]~input_o\ & (\SW[7]~input_o\ & (\SW[6]~input_o\ $ (!\SW[2]~input_o\)))) # (!\SW[3]~input_o\ & (!\SW[7]~input_o\ & (\SW[6]~input_o\ $ (!\SW[2]~input_o\))))
...
-- Equation(s):
-- \inst|and_1~combout\ = (\inst|and_1~0_combout\ & \inst|and_1~1_combout\)
...
-- pragma translate_on
PORT MAP (
	datab => \inst|and_1~0_combout\,
	datad => \inst|and_1~1_combout\,
