...
public class CalcFracParser extends Parser {
	...
	public static class ProgramContext extends ParserRuleContext {
		...
		public List<TerminalNode> NEWLINE() { return getTokens(CalcFracParser.NEWLINE); }
		public TerminalNode NEWLINE(int i) {
			return getToken(CalcFracParser.NEWLINE, i);
		}
	...
	public static class ExpExponentContext extends ExprContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CalcFracListener ) ((CalcFracListener)listener).enterExpExponent(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CalcFracListener ) ((CalcFracListener)listener).exitExpExponent(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalcFracVisitor ) return ((CalcFracVisitor<? extends T>)visitor).visitExpExponent(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
