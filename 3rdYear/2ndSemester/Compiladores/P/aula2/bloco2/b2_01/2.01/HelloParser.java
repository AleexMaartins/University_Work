...
public class HelloParser extends Parser {
	...
	public static final int
		RULE_greetings = 0, RULE_goodbyes = 1;
	...
	public static class GoodbyesContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HelloListener ) ((HelloListener)listener).enterGoodbyes(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof HelloListener ) ((HelloListener)listener).exitGoodbyes(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof HelloVisitor ) return ((HelloVisitor<? extends T>)visitor).visitGoodbyes(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final GoodbyesContext goodbyes() throws RecognitionException {
		...
		enterRule(_localctx, 2, RULE_goodbyes);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(7);
