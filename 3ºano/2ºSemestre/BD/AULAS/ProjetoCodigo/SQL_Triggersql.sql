...
as
	...
	begin
		raiserror('Erro! Não é possível adicionar Modelo sem especialização',16,1)
	end
	else
...
as
	...
	begin
		raiserror('Erro! Não é possível existir Modelo com mais que uma especialização',16,1)
...
as
	...
	begin
		raiserror('Erro! Não é possível adicionar Pessoa sem especialização',16,1)
	end
	else
