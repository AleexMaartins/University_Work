...
Entidades:
-Produto (código, nome, IVA, preço, unidade_em_armazém)
-Encomenda (número_de_encomenda, data)
-Fornecedor (NIF, nome, endereço, fax, condição_de_pagamento)
-Tipo_Fornecedor (designação)
...
-grau 2
-cardinalidade (N:M)
-Encomenda é obrigado a ter Produto

Encomenda - Fornecedor:
-grau 2
-cardinalidade (1:N)
-Encomenda é obrigado a ter Fornecedor

Fornecedor - Tipo_Fornecedor:
-grau 2
-cardinalidade (N:1)
-Fornecedor é obrigado a ter Tipo_Fornecedor
