-- STORED PROCEDURES
drop proc EAP.addModeloCombustao
...
create procedure EAP.addViagem (@hora_inicio time, @autocarro_id int, @condutor_id int)
as
begin
	set nocount on
	begin transaction
		insert into EAP.Viagem (hora_inicio, autocarro_id, condutor_id)
		values (@hora_inicio, @autocarro_id, @condutor_id)
	commit transaction
end
