...
def test_exercicio11(braga_faro):#feito
...
def test_exercicio12(braga_faro):#feito
...
def test_exercicio13(braga_faro): #feito
...
def test_exercicio14(braga_faro): #feito
...
def test_exercicio15(braga_faro): #feito
...
def test_exercicio16(braga_faro): #feito                                        
    t = SearchTree(braga_faro, 'uniform')
    t.search()
